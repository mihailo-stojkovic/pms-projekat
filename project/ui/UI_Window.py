...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditPrag = QLineEdit(self.centralwidget)
        self.lineEditPrag.setObjectName(u"lineEditPrag")
        self.lineEditPrag.setGeometry(QRect(640, 210, 113, 20))
        ...
        self.lineEditMin = QLineEdit(self.centralwidget)
        self.lineEditMin.setObjectName(u"lineEditMin")
        self.lineEditMin.setGeometry(QRect(640, 280, 113, 20))
